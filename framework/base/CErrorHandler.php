 ...
 *
 * It displays these errors using appropriate views.old based on the
 ...
 *
 * CErrorHandler uses two sets of views.old:
 * <ul>
 * <li>development views.old, named as <code>exception.php</code>;
 * <li>production views.old, named as <code>error&lt;StatusCode&gt;.php</code>;
 * </ul>
 * where &lt;StatusCode&gt; stands for the HTTP error code (e.g. error500.php).
 * Localized views.old are named similarly but located under a subdirectory
 * whose name is the language code (e.g. zh_cn/error500.php).
 *
 * Development views.old are displayed when the application is in debug mode
 * (i.e. YII_DEBUG is defined as true). Detailed error information with source code
 * are displayed in these views.old. Production views.old are meant to be shown
 ...
 * <ol>
 * <li><code>themes/ThemeName/views.old/system</code>: when a theme is active.</li>
 * <li><code>protected/views.old/system</code></li>
 * <li><code>framework/views.old</code></li>
 * </ol>
 ...
 * of source code lines to be displayed in development views.old.
 *
...
class CErrorHandler extends CApplicationComponent
{
	 ...
	 * @param string $viewPath the directory containing the views.old
	 * @param string $view view name (either 'exception' or 'error')
	 * @param integer $code HTTP status code
