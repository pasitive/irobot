...
class ControllerCommand extends CConsoleCommand
{
	 ...
	 * Defaults to null, meaning using 'framework/cli/views.old/shell/controller'.
	 * If you set this path and some views.old are missing in the directory,
	 * the default views.old will be used.
	 */
	public $templatePath;
