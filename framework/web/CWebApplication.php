...
class CWebApplication extends CApplication
{
	...
	/**
	 * @return string the root directory of view files. Defaults to 'protected/views.old'.
	 */
	...
	/**
	 * @return string the root directory of system view files. Defaults to 'protected/views.old/system'.
	 */
	...
	/**
	 * @return string the root directory of layout files. Defaults to 'protected/views.old/layouts'.
	 */
