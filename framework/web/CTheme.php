...
class CTheme extends CComponent
{
	...
	/**
	 * @return string the path for controller views.old. Defaults to 'ThemeRoot/views.old'.
	 */
	...
	/**
	 * @return string the path for system views.old. Defaults to 'ThemeRoot/views.old/system'.
	 */
	...
	/**
	 * @return string the path for widget skins. Defaults to 'ThemeRoot/views.old/skins'.
	 * @since 1.1
	 */
