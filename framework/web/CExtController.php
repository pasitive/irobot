 ...
 * so that it points to the "views.old" subdirectory under the directory containing
...
class CExtController extends CController
{
	 ...
	 * to be the "views.old" subdirectory under the directory containing the controller
	 * class file.
