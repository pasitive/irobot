 ...
 * into the controller-managed views.old.
 *
...
class CWidget extends CBaseController
{
	 ...
	 * The default implementation returns the 'views.old' subdirectory of the directory containing the widget class file.
	 * If $checkTheme is set true, the directory "ThemeID/views.old/ClassName" will be returned when it exists.
