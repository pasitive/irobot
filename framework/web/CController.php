 ...
 *
 * Through the actions, CController coordinates the data flow between models and views.old.
 *
...
class CController extends CBaseController
{
	...
	/**
	 * @var mixed the name of the layout to be applied to this controller's views.old.
	 ...
	 * The default implementation returns 'protected/views.old/ControllerID'.
	 ...
	 * @return string the directory containing the view files for this controller. Defaults to 'protected/views.old/ControllerID'.
	 */
	 ...
	 * The view file is determined by calling {@link YiiBase::getPathOfAlias()}. Note that aliased views.old
	 * cannot be themed because they can refer to a view file located at arbitrary places.</li>
	 * <li>relative view: otherwise. Relative views.old will be searched for under the currently active
	 ...
	 *
	 * By default, the layout view script is "protected/views.old/layouts/main.php".
